...
$stmt = $db->prepare(
  "SELECT position.position_id, position_name, p.player_id, first_name.name_text,
    last_name.last_name_text, player_age, team_captain,
...
$stmt->bind_result($position_id, $position, $player_id, $player_fname, $player_lname, $player_age, $team_captain, $average);
// store collected
$player_result = array();
$team_score = 0;
while($stmt->fetch()){
